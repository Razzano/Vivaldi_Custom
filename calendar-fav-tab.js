(function() {
  ...
  const initializeDelay = 20,
		...
		moveBtn = 'background: url(/style/calendar-fav-tab/tab.png) center no-repeat',
  ...
  function getCurrentTab() {
    ...
    try {
      ...
      chrome.tabs.query({currentWindow: true, active: true}, tabs => {
		...
		else if (tabs[0].title.match(/Settings$/)) img.src = '/style/calendar-fav-tab/settings.png';
        else if (tabs[0].title.match(/Start Page$/)) img.src = '/style/calendar-fav-tab/star.png';
		else if (tabs[0].title.match(/Gmail$/)) img.src = '/style/calendar-fav-tab/gmail.png';
