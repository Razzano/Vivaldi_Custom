(() => {
  ...
  function setRewindForward() {
	...
	mainbar.insertBefore(div, mainbar.childNodes[4]);
  ...
  function setToggleButton() {
    let browser = $q('#browser'),
		...
		statusBar = $q('.toolbar-statusbar'),
		trash = $q('.toggle-trash'),
		label15 = $q('#label15'),
	    label16 = $q('#label16'),
		label17 = $q('#label17'),
		label18 = $q('#label18'),
		div1 = $c('div', {id: 'toggleDiv', className: 'toggle-div'}),
	...
	try {
	  ...
	  //if (browser.classList.contains('disable-titlebar')) div1.appendChild(trash); (work in progress for tabs right)
	  if (browser.classList.contains('tabs-left')) div1.appendChild(trash);
	  tabs.insertBefore(div1, tabs.firstChild);
	  removeDupes('toggle-div');
	  if (toolbarToggle) {
	    label16.removeAttribute('disabled');
	    label17.removeAttribute('disabled');
	    label18.removeAttribute('disabled');
	  ...
	  if (browser.classList.contains('tabs-left')) {
	    label15.setAttribute('disabled', true);
		label16.setAttribute('disabled', true);
	    label17.setAttribute('disabled', true);
	    label18.setAttribute('disabled', true);
	  } else {
