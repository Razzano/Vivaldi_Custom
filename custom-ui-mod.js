  ...
  function getCurrentTab() {
    ...
    try {
      ...
      chrome.tabs.query({currentWindow: true, active: true}, tabs => {
		...
		else if (tabs[0].title.match(/General/gi)) img.src = '/style/icons/settings.png';
		else if (tabs[0].title.match(/^Settings/gi)) img.src = '/style/icons/vivaldi16.png';
		...
		else if (tabs[0].title.match(/Start Page/gi)) img.src = '/style/icons/start.png';
		else if (tabs[0].title.match(/Themes/gi)) img.src = '/style/icons/themes.png';
