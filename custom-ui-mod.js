(() => {
  ...
  function setToggleButton() {
    let browser = $q('#browser'),
		...
		//brk = $q('.button-toolbar > button[name="BreakMode"]'),
	    label16 = $q('#label16'),
		label17 = $q('#label17'),
		label18 = $q('#label18'),
		div2 = $c('div', {id: 'toggleDiv', className: 'toggle-div'}),
	...
	try {
	  ...
	  if (browser.classList.contains('tabs-left') || browser.classList.contains('tabs-right')) {
