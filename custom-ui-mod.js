  ...
  function setOptionsMenu() {
	...
	try {
      optMenu.innerHTML = '\
		...
		<label id="label0" class="label">\
          <span id="span0">\
		    <svg xmlns="http://www.w3.org/2000/svg" style="'+ starIcon +'"/>\
		  </span>\
		  <span id="span0a">'+ span0aText +'</span>\
		  <span id="span0b">'+ span0bText +'</span>\
        </label>\
...
// --------------------------------------------------------------------------------------------------------------------
  ...
  let fullScreenInterval = setInterval(() => {
    ...
    if (webView) {
      ...
      vivaldi.tabsPrivate.onKeyboardShortcut.addListener((id, combination) => combination === span0bText && toggleFullScreen());
