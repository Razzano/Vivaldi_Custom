(() => {
  ...
  const initializeDelay = 200,
		...
		label2Tooltip = 'Custom CSS for Issuna Dark Theme',
        span2Text = 'Custom CSS For Issuna Dark Theme',
  ...
  function getCurrentTab() {
    ...
    try {
      ...
      chrome.tabs.query({currentWindow: true, active: true}, tabs => {
		...
		else if (tabs[0].title.match(/Lincoln.comgi/)) img.src = '/style/icons/lincoln.png';
        ...
        else if (tabs[0].url.match(/https:\/\/www\.aarpmedicareplans/gi)) img.src = '/style/icons/united.png';
  ...
  function optionsMenu() {
    ...
    divY.innerHTML = '\
	  ...
	  <label id="setOrder" for="input11">'+ setOrderText +'</label>\
