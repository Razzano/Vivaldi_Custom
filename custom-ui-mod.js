(() => {
  ...
  function getCurrentTab() {
    ...
    try {
      ...
      chrome.tabs.query({currentWindow: true, active: true}, tabs => {
		...
		if (web) {
		  if (tabs[0].title.match(/General/i)) img.src = '/style/icons/settings.png';
		  else if (tabs[0].title.match(/Sync/i)) img.src = '/style/icons/synced.png';
		  else if (tabs[0].title.match(/Appearance/i)) img.src = '/style/icons/appearance.png';
		  else if (tabs[0].title.match(/Themes/i)) img.src = '/style/icons/themes.png';
		  else if (tabs[0].title.match(/Startpage/i)) img.src = '/style/icons/startpage.png';
		  else if (tabs[0].title.match(/Tabs/i)) img.src = '/style/icons/tabs.png';
		  else if (tabs[0].title.match(/Panel/i)) img.src = '/style/icons/panel.png';
		  else if (tabs[0].title.match(/Addressbar/i)) img.src = '/style/icons/addressbar.png';
		  else if (tabs[0].title.match(/Bookmarks/i)) img.src = '/style/icons/bookmark.png';
		  else if (tabs[0].title.match(/Search/i)) img.src = '/style/icons/search.png';
		  else if (tabs[0].title.match(/Qc/i)) img.src = '/style/icons/quick.png';
		  else if (tabs[0].title.match(/Keyboard/i)) img.src = '/style/icons/keyboard.png';
		  else if (tabs[0].title.match(/Mouse/i)) img.src = '/style/icons/mouse.png';
		  else if (tabs[0].title.match(/Privacy/i)) img.src = '/style/icons/blocker.png';
		  else if (tabs[0].title.match(/Downloads/i)) img.src = '/style/icons/downloads.png';
		  else if (tabs[0].title.match(/Webpages/i)) img.src = '/style/icons/nfcu.png';
		  else if (tabs[0].title.match(/Network/i)) img.src = '/style/icons/network.png';
		  else if (tabs[0].title.match(/Mail/i)) img.src = '/style/icons/mail.png';
		  else if (tabs[0].title.match(/Calendar/i)) img.src = '/style/icons/calendar.png';
		  else if (tabs[0].title.match(/rss/i)) img.src = '/style/icons/feeds.png';
		  else if (tabs[0].title.match(/All/i)) img.src = '/style/icons/settings.png';
		}
		if (menu) {
  ...
  function setOptionsMenu() {
	...
	try {
      optMenu.innerHTML = '\
        <div id="div0">\
          <button id="position-menu" class="button" title="'+ optionsMenuPositionTooltip +'"></button>\
		...
		<label id="label8" class="label" title="' + label8Tooltip +'">\
          <input id="input8" class="input" type="checkbox"/>\
		...
		<label id="label20" class="label" title="'+ label20Tooltip +'">\
          <input id="input20" class="input" type="checkbox"/>\
	  ...
	  $q('div#options-menu #input8').checked = extensionIcons;
	  ...
	  $q('div#options-menu #input20').checked = syncedTabs;
