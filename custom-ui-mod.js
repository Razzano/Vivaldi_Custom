...
*/
  ...
  function showDialog(linkUrl, fromPanel) {
	...
	divOptionContainer.style.top = (100 - (100 - 5 * webviews.size)) / 2 - 2.5 + '%';
    ...
    progressBarContainer.style.margin = '1.2% 0 0 1%';
  ...
  function showWebviewOptions(webviewId, thisElement) {
    ...
    if (webview && document.getElementById(inputId) === null) {
      ...
      input.style.margin = '-4px 0px 0 0px';
      input.style.padding = '0.25rem 0.5rem';
	  input.style.textOverflow = 'ellipsis';
      input.style.width = '280px';
      setBackButtonContent(buttonBack);
	  buttonBack.style.margin = "0px";
	  ...
	  buttonForward.style.margin = "0px";
	  ...
	  buttonClose.style.margin = "-4px 0 0 0";
  ...
  function getCloseButtonContent() {
	return '<svg xmlns="http://www.w3.org/2000/svg" height="17px" viewBox="0 0 12 12"><path d="m12.5 5-1.4-1.4-3.1 3-3.1-3L3.5 5l3.1 3.1-3 2.9 1.5 1.4L8 9.5l2.9 2.9 1.5-1.4-3-2.9"/></svg>';
  }
