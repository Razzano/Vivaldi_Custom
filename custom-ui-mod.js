(() => {
  ...
  function onClose() {
	...
	window.removeEventListener("dragend", e => setTimeout(() => { e.preventDefault(); homeToRestart(homeRestart) }, resizeDelay));
	window.removeEventListener("focus", () => setTimeout(() => reloadElements(), resizeDelay));
	window.removeEventListener("fullscreenchange", () => setTimeout(() => reloadElements(), resizeDelay));
    window.removeEventListener("resize", () => setTimeout(() => reloadElements(), resizeDelay));
  ...
  window.addEventListener("fullscreenchange", () => setTimeout(() => reloadElements(), resizeDelay));
  window.addEventListener("load", () => setTimeout(() => initialize(), initializeDelay));
  window.addEventListener("resize", () => setTimeout(() => reloadElements(), resizeDelay));
