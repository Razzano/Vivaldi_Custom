...
/*   Link in Dialog Window                                                        */
/*   https://forum.vivaldi.net/topic/92501/open-in-dialog-mod/2   BY: oudstand    */
...
/*   https://forum.vivaldi.net/topic/38084/open-link-or-new-tab-in-a-dialog-mod   */
    ...
    function dialogTab(linkUrl) {
        ...
        webview.style.width = 95 * webviews.size + "%";
        webview.style.height = 95 * webviews.size + "%";
        ...
        divOptionContainer.style.width = "80%";
		divOptionContainer.style.height = "26px";
		divOptionContainer.style.padding = "0";
		divOptionContainer.style.borderRadius = "13px";
