(() => {
  ...
  const initializeDelay = 100,
		...
		label16Tooltip = 'Hide Footer',
        span16Text = 'Hide Footer',
		label17Tooltip = 'Hide Bookmark-bar',
        span17Text = 'Hide Bookmark-bar',
		label18Tooltip = 'Hide Mainbar',
        span18Text = 'Hide Mainbar',
		setOrderText = '\u2193 \u2007 Set Toolbar Order \u2007 \u2193',
        asterisk = '*', bullet = '\u2022', colon = ':', colons = '::', comma = ',', gt = '>', hyphen = '-', lt = '<', slash = '/', space = ' ', star = '\u2606',
  ...
  function optionsMenu() {
    ...
    divY.innerHTML = '\
      ...
      <label id="label1" class="label" title="' + label1Tooltip +'">\
        ...
        <span id="span1" class="span">'+ span1Text +'</span>\
      </label>\
	  ...
	  <label id="setOrder" style="background: #000; color: lime; margin-top: 4px; text-align: center">'+ setOrderText +'</label>\
