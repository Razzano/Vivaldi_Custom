...
write-host "Writing custom-ui-mod\common.css into vivaldi\style\common.css"
$Common = Get-Content $dstdir\style\common.css
Add-Content $srcdir\common.css $Common

write-host "Writing custom-ui-mod\custom-ui-mod.css into vivaldi\style\common.css"
