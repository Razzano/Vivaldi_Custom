...
findstr /v "^$" $dstdir\browser.html > $srcdir\restore.html
...
$html2 = Get-Content (join-path $srcdir "restore.html") -encoding UTF8
findstr /v "^$" $srcdir\restore.html > $dstdir\browser.html
