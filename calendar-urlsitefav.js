  ...
  function getCurrentTab() {
    ...
    try {
      ...
      chrome.tabs.query({currentWindow: true, active: true}, tabs => {
        if (tabs[0].title.match(/Extensions$/)) img.src = '/style/calendar-urlsitefav/extensions.png';
		else if (tabs[0].title.match(/Settings$/)) img.src = '/style/calendar-urlsitefav/settings.png';
        else if (tabs[0].title.match(/Start Page$/)) img.src = '/style/calendar-urlsitefav/star.png';
        else if (tabs[0].title.match(/Installed Userscripts$/)) img.src = '/style/calendar-urlsitefav/tampermonkey16.png';
        else if (tabs[0].title.match(/YouTube TV$/)) img.src = '/style/calendar-urlsitefav/youtubetv.png';
        else if (!tabs[0].favIconUrl)  img.src = '/style/calendar-urlsitefav/page.png';
