  ...
  function getCurrentTab() {
    ...
    try {
      ...
      chrome.tabs.query({currentWindow: true, active: true}, tabs => {
        ...
        else if (tabs[0].title.match(/Settings$/)) img.src = '/style/complete/settings.png';
        else if (tabs[0].title.match(/Start Page$/)) img.src = '/style/complete/star.png';
		else if (tabs[0].title.match(/Gmail$/)) img.src = '/style/complete/gmail.png';
		else if (tabs[0].title.match(/Lincoln.com$/)) img.src = '/style/complete/lincoln.png';
        else if (tabs[0].title.match(/Tampermonkey/)) img.src = '/style/complete/tampermonkey16.png';
