...
try {
  ...
  if ($writeneeded -eq 1) {
    ...
    write-host "The vivaldi browser.html already includes references to complete_.css and vivald-custom-complete_.js"
  }
  write-host "Copying vivald-custom-complete_.js to vivaldi folder"
