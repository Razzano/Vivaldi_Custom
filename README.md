Zip file contains 2 bat files, 1 js file, 1 css file, png icons and a how-to install text file. Posted complete.zip file contents separately minus the how-to install text file.
