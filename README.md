Updated for 6.5.3206.39 (Stable channel) (64-bit)
...
Click the custom-ui-mod-Uninstall.bat to remove the installed files from the Vivaldi Browser App. Follow the simple instructions in the how-to.txt file.
